  ...
  return (
    <AppFrame title="Ustawienia">
      ...
      <Card id="csv" className="mt-4">
        ...
        <CardContent>
          <form action="/api/import/csv" method="post" encType="multipart/form-data" className="grid gap-3 md:grid-cols-[1fr_auto]">
          ...
          <p className="mt-2 text-sm text-slate-500">Obsługiwane kolumny: data, typ, kwota, kategoria, metoda, opis. Typ: income albo expense.</p>
        </CardContent>
      </Card>
    </AppFrame>
  );
